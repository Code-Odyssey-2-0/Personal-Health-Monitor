...
public class Hospitalisation  extends FirestoreRecyclerAdapter<Fiche,Hospitalisation.FicheHolder2> {

    public Hospitalisation(@NonNull FirestoreRecyclerOptions<Fiche> options) {
        super(options);
    }
